...
document.onclick = function(event) {
  ...
  if(target.tagName.toLowerCase() === 'img') {
    ...
    content.innerHTML = showMedia(jsonMovie);
  }
}
...
const jsonMovie = JSON.parse('{"Title": "Jaws","Year": "1975",' +
  '"Rated": "PG","Released": "20 Jun 1975","Runtime": "124 min",' +
  '"Genre": "Adventure, Thriller","Director": "Steven Spielberg",' +
